            ...
            <Card className="p-4 shadow bg-dark text-light">
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  manager and claims manager has made me goal-oriented and
                  driven. I’m excited to apply these skills in programming,
                  where I’m eager to learn, solve problems, and contribute to a
